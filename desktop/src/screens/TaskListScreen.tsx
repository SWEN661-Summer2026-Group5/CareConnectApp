...
export default function TaskListScreen({
  ...
  const { activeTasks, completedTasks, sortTasksAsc, toggleTaskSort, setTaskSort } =
    useAppState();
  const [showCompleted, setShowCompleted] = useState(false);

  // Expose Ctrl+Up / Ctrl+Down sort control to the shortcut layer.
  useScreenActions(
    {
      onSortAsc: () => setTaskSort(true),
      onSortDesc: () => setTaskSort(false),
    },
    [setTaskSort],
  );
